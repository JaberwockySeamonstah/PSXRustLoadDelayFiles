...
main:
	...
	addiu	$4, $zero, 256
	addiu	$5, $zero, 16
	lui	$1, %hi($anon.1f41b716b021763648a3f50d78c68991.64)
	#APP
	.set	push
	.set	at
	.set	macro
	...
	.set	pop
	#NO_APP
	addiu	$4, $1, %lo($anon.1f41b716b021763648a3f50d78c68991.64)
...
$BB1_36:
	...
	sw	$2, 0($1)
$BB1_38:
	lui	$1, %hi(_ZN10puddle_sdk10peripheral13CONTROLLERS_A17h23c028aeeb95cc2cE)
	lui	$2, 32
	...
	lui	$22, 256
	sw	$23, 100($sp)
	addiu	$17, $1, %lo(_ZN10puddle_sdk10peripheral13CONTROLLERS_A17h23c028aeeb95cc2cE)
	addiu	$1, $23, 6
	ori	$2, $2, 88
...
$BB1_386:
	...
	addiu	$1, $zero, 4
	sw	$1, 148($sp)
	lui	$1, %hi($anon.1f41b716b021763648a3f50d78c68991.13)
	addiu	$1, $1, %lo($anon.1f41b716b021763648a3f50d78c68991.13)
	sw	$1, 140($sp)
	sw	$zero, 156($sp)
...
$BB22_4:
	...
	nop
$BB22_5:
	lui	$1, %hi($anon.1f41b716b021763648a3f50d78c68991.1)
	jal	tty_printf
	addiu	$4, $1, %lo($anon.1f41b716b021763648a3f50d78c68991.1)
	j	$BB22_8
	nop
$BB22_6:
	lw	$1, 0($4)
	...
	lw	$5, 0($1)
$BB22_7:
	lui	$1, %hi($anon.1f41b716b021763648a3f50d78c68991.0)
	jal	tty_printf
	addiu	$4, $1, %lo($anon.1f41b716b021763648a3f50d78c68991.0)
$BB22_8:
	j	$BB22_8
	nop
	.set	at
...
$BB30_5:
	...
	bnez	$2, $BB30_5
	nop
	lui	$3, %hi(_ZN10puddle_sdk10peripheral13CONTROLLERS_A17h23c028aeeb95cc2cE)
	addiu	$16, $zero, 3
	addiu	$2, $3, %lo(_ZN10puddle_sdk10peripheral13CONTROLLERS_A17h23c028aeeb95cc2cE)
	lbu	$4, 2($2)
	nop
	bne	$4, $16, $BB30_10
	nop
...
$BB30_10:
	beqz	$4, $BB30_58
	lbu	$3, %lo(_ZN10puddle_sdk10peripheral13CONTROLLERS_A17h23c028aeeb95cc2cE)($3)
	addiu	$1, $zero, 1
	bne	$4, $1, $BB30_61
	nop
	andi	$1, $3, 1
...
$BB30_54:
	...
	andi	$1, $16, 3
	or	$1, $2, $1
	lui	$2, %hi(_ZN10puddle_sdk10peripheral13CONTROLLERS_A17h23c028aeeb95cc2cE)
	addiu	$2, $2, %lo(_ZN10puddle_sdk10peripheral13CONTROLLERS_A17h23c028aeeb95cc2cE)
	sb	$1, 3($2)
	sltiu	$1, $18, 1
	bnez	$1, $BB30_57
	addiu	$3, $zero, 65
...
planschi:
	...
	nop
	lui	$1, %hi(_ZN10puddle_sdk10peripheral13CONTROLLERS_A17h23c028aeeb95cc2cE)
	addiu	$1, $1, %lo(_ZN10puddle_sdk10peripheral13CONTROLLERS_A17h23c028aeeb95cc2cE)
	j	$BB30_75
	sh	$16, 2($1)
$BB30_61:
	jal	_ZN10puddle_sdk10peripheral17serial_connection16SerialConnection30get_controller_state_form_slot17hf598d3a126647603E
	...
	lui	$1, %hi(_ZN10puddle_sdk10peripheral13CONTROLLERS_A17h23c028aeeb95cc2cE)
	lbu	$3, 2($sp)
	addiu	$4, $1, %lo(_ZN10puddle_sdk10peripheral13CONTROLLERS_A17h23c028aeeb95cc2cE)
	lbu	$1, 10($4)
	nop
	beq	$1, $3, $BB30_64
	nop
...
$anon.ae70372eae0dbf6a2e2aa65da33fd719.25:
	...
	.type	$anon.1f41b716b021763648a3f50d78c68991.0,@object
	.section	.rodata.str1.1,"aMS",@progbits,1
$anon.1f41b716b021763648a3f50d78c68991.0:
	.asciz	"Waaah panic: %s\n"
	.size	$anon.1f41b716b021763648a3f50d78c68991.0, 17

	.type	$anon.1f41b716b021763648a3f50d78c68991.1,@object
$anon.1f41b716b021763648a3f50d78c68991.1:
	.asciz	"Waaah panic!!\n"
	.size	$anon.1f41b716b021763648a3f50d78c68991.1, 15

	.type	_ZN10puddle_sdk10peripheral13CONTROLLERS_A17h23c028aeeb95cc2cE,@object
	.section	.data._ZN10puddle_sdk10peripheral13CONTROLLERS_A17h23c028aeeb95cc2cE,"aw",@progbits
	.p2align	2, 0x0
_ZN10puddle_sdk10peripheral13CONTROLLERS_A17h23c028aeeb95cc2cE:
	.ascii	"\001\003\003"
	.space	9
	.size	_ZN10puddle_sdk10peripheral13CONTROLLERS_A17h23c028aeeb95cc2cE, 12
...
_ZN10puddle_sdk3gpu12VBLANK_COUNT17h398c8b6e742c5a10E:
	...
	.type	$anon.1f41b716b021763648a3f50d78c68991.12,@object
	.section	".rodata.$anon.1f41b716b021763648a3f50d78c68991.12","a",@progbits
$anon.1f41b716b021763648a3f50d78c68991.12:
	.ascii	"value out of bounds [0, 16777215]"
	.size	$anon.1f41b716b021763648a3f50d78c68991.12, 33

	.type	$anon.1f41b716b021763648a3f50d78c68991.13,@object
	.section	".rodata.$anon.1f41b716b021763648a3f50d78c68991.13","a",@progbits
	.p2align	2, 0x0
$anon.1f41b716b021763648a3f50d78c68991.13:
	.4byte	$anon.1f41b716b021763648a3f50d78c68991.12
	.asciz	"!\000\000"
	.size	$anon.1f41b716b021763648a3f50d78c68991.13, 8
...
_ZN10puddle_sdk5timer19TIMER2_10MS_COUNTER17ha3160beb26df583bE.0:
	...
	.type	$anon.1f41b716b021763648a3f50d78c68991.64,@object
	.section	.rodata.str1.1,"aMS",@progbits,1
$anon.1f41b716b021763648a3f50d78c68991.64:
	.asciz	"%.*s"
	.size	$anon.1f41b716b021763648a3f50d78c68991.64, 5
